...
@@
      ...
      <div className="mx-auto grid max-w-[1440px] gap-12 px-5 py-12 sm:px-8 lg:grid-cols-[1.2fr_0.8fr_0.7fr] lg:px-12">
        ...
        <div>
          ...
          <a href="https://www.instagram.com/pongelli.wav/?__pwa=1" target="_blank" rel="noreferrer" aria-label="Instagram: pongelli.wav" className="mt-5 inline-grid h-9 w-9 place-items-center border border-white/25 text-white/80 hover:border-[#f5d692] hover:text-[#f5d692]"><Instagram className="h-4 w-4" /></a>
        </div>
      </div>
    </footer>
  );
